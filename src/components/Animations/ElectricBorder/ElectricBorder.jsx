...
const ElectricBorder = ({
  ...
  // Calculate the extended area for the border
  const borderOffset = thickness + 2; // Extra padding to ensure full coverage
  ...
  return (
    ...
    >
      ...
      {/* Border Container - Extended beyond content area */}
      <div
      ...
      >
        ...
        <div
          ...
          style={{
            ...inheritRadius,
            border: `${thickness}px solid ${hexToRgba(color, 0.8)}`,
        ...
        <div
          ...
          style={{
            ...
            background: `linear-gradient(-30deg, ${hexToRgba(
              color,
              0.2
            )}, transparent, ${hexToRgba(color, 0.1)})`,
            filter: "blur(4px)",
            opacity: 0.4,
            zIndex: 47,
